...
public class OrderActivity extends AppCompatActivity {
    ...
    private static final int SMALL_PRICE = 50;
    private static final int MEDIUM_PRICE = 60;
    private static final int LARGE_PRICE = 70;

    private static final String TEA_SIZE_SMALL = "Small (50Rs/cup)";
    private static final String TEA_SIZE_MEDIUM = "Medium (70Rs/cup)";
    private static final String TEA_SIZE_LARGE = "Large (90Rs/cup)";
